...
class TestBasketView(TestCase):
    ...
    def setUp(self):
        ...
        Product.objects.create(category_id=1, title='django test1', created_by_id=1,
                               slug='django-test', price='20.00', image='django')
        Product.objects.create(category_id=1, title='django test2', created_by_id=1,
                               slug='django-test', price='20.00', image='django')
        Product.objects.create(category_id=1, title='django test3', created_by_id=1,
                               slug='django-test', price='20.00', image='django')
        self.client.post(
